...
A minimal implementation of an escrow smarts contract using Soroban SDK, allowing two parties (a buyer and a seller) to engage in a trusted transaction. Funds are held securely in escrow until manually released.
